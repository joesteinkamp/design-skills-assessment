...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      valueTen: 0,
      data: {
        labels: ['Information Architecture', 'Visual Design', 'Interaction Design', 'Storytelling', 'Design Toolset', 'Technical Literacy', 'Business Literacy', 'Service Design', 'Human Factors', 'Research & Data'],
        datasets: [
          {
  ...
  handleTypeChange(i) {
    ...
    if (i === 1) {
      ...
      this.setState({
        diagramVisible: false,
        data: {
          labels: ['Information Design', 'Graphic Design', 'Motion Design', 'Storytelling', 'Brand Identity Design', 'Content Strategy', 'Business Literacy', 'Service Design', 'Human Factors', 'Research & Data']
        }
      });
    }
    else if (i === 3) {
